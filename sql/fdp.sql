...
CREATE TABLE IF NOT EXISTS delivery_project (
  ...
  deployment_profile VARCHAR(32) NOT NULL DEFAULT 'LIGHTWEIGHT' COMMENT 'legacy compatibility field',
...
CREATE TABLE IF NOT EXISTS artifact_delivery_project (
  ...
  env_file VARCHAR(512) NULL COMMENT 'legacy server-side env path',
  env_content_ciphertext LONGTEXT NULL COMMENT 'AES-GCM encrypted FDP-managed KEY=VALUE content',
